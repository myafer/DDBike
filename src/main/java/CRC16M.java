public class CRC16M {
	...
	public static void main(String[] args) {
		...
		byte[] test = { (byte) 0xFE, 0x05, 0x00, 0x00, (byte) 0xFF, 0x00};

//		byte[] sbuf = CRC16M.getBufHexStr(test);

		System.out.println(CRC16M.getBufHexStr(CRC16M.getSendBuf(CRC16M.getBufHexStr(test))));
	}
